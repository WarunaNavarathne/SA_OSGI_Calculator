...
import pe_producer.PEImpl;



public class PE_Display extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			@Override
			public void run() {
				PE_Display display = new PE_Display();
	...
	public PE_Display() throws HeadlessException {
		
		setResizable(false);
		setTitle("Potential Energy Calculator");
		...
		label4 = new JLabel("g = Gravity ");
		label4.setFont(new Font("Calibri", Font.PLAIN, 25));
		label4.setBounds(230, 150, 400, 60);
		panel.add(label4);
		
		label8 = new JLabel("h = Height ");
		label8.setFont(new Font("Calibri", Font.PLAIN, 25));
		label8.setBounds(230, 185, 400, 60);
		panel.add(label8);
		
		
		label5 = new JLabel("m");
		label5.setFont(new Font("Calibri", Font.PLAIN, 20));
		label5.setBounds(90, 240, 400, 60);
		panel.add(label5);
		
		label6 = new JLabel("g");
		label6.setFont(new Font("Calibri", Font.PLAIN, 20));
		label6.setBounds(275, 240, 400, 60);
		panel.add(label6);
		
		label7 = new JLabel("h");
		label7.setFont(new Font("Calibri", Font.PLAIN, 20));
		label7.setBounds(460, 240, 400, 60);
		panel.add(label7);
		...
		in2.setBounds(215, 280, 150, 40);
		panel.add(in2);
		
		JTextField in4 = new JTextField();
		in4.setHorizontalAlignment(SwingConstants.CENTER);
		in4.setFont(new Font("Arial Nova", Font.PLAIN, 25));
		in4.setBounds(400, 280, 150, 40);
		panel.add(in4);
		...
		btn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				IPE ipe = new PEImpl();
				double ans = 0;
				ans = ipe.PEcal(Double.parseDouble(in1.getText()), Double.parseDouble(in2.getText()),Double.parseDouble(in4.getText()));
