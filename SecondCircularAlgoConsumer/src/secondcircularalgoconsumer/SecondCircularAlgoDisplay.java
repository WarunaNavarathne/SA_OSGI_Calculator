...
import secondcircularalgoproducer.SecondCircularAlgoImpl;



public class SecondCircularAlgoDisplay extends JFrame {
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				// TODO Auto-generated method stub
				SecondCircularAlgoDisplay seconddisplay = new SecondCircularAlgoDisplay();
				seconddisplay.setVisible(true);
			}
		});
	}

	public SecondCircularAlgoDisplay() throws HeadlessException  {
		...
		label = new JLabel("a = r * w^2");
		label.setFont(new Font("Calibri", Font.BOLD, 50));
		label.setBounds(180, 30, 400, 60);
		panel.add(label);
		
		label4 = new JLabel("a = Angular Acceleration");
		label4.setFont(new Font("Calibri", Font.PLAIN, 25));
		label4.setBounds(170, 80, 400, 60);
		panel.add(label4);
		
		label5 = new JLabel("w = Angular Velocity");
		label5.setFont(new Font("Calibri", Font.PLAIN, 25));
		label5.setBounds(170, 115, 400, 60);
		panel.add(label5);
		
		
		label6 = new JLabel("r = Radius");
		label6.setFont(new Font("Calibri", Font.PLAIN, 25));
		label6.setBounds(170, 150, 400, 60);
		panel.add(label6);
		...
		btn1 = new JButton("Angular Acceleration");
		...
		btn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				ISecondCircularAlgo algo1 = new SecondCircularAlgoImpl();
				double answer = 0;
				
				answer = algo1.AngularAcceleration(Double.parseDouble(in1.getText()), Double.parseDouble(in2.getText()));
